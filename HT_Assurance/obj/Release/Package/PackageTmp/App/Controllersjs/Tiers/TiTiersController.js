MapharApp.controller("TiTiersController", [
  "$scope",
  "$http",
  "$q",
  "$location",
  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
    ...
    $scope.initFormAddTiTiers = function () {
      ...
      $scope.FormAddTiTiers.pays = $rootScope.PAYSPARDEFAUT
      $scope.FormAddTiTiers.ville = $rootScope.VILLEPARDEFAUT
    };
    ...
    $scope.afficheListeTiTiers = function (
      periodeDu,
      periodeAu,
      numDuTiers,
      nomDuTiers
    ...
    $scope.voirModifDesTiers = function (info) {
      ...
      window.location.href = "#/gestion/modification/tiers";
    };
    //debut acceder a la page de modification
    ...
    $scope.afficheListeVille = function (id) {
      ...
      if($scope.FormAddTiTiers.ville == undefined || $scope.FormAddTiTiers.ville == ""){
    ...
    $scope.desactiverChampRequisEnregistrement = function () {
      $(document).ready(function () {
        ...
        $("#idPlafondCred").focusin(function () {
          $(this).css("background-color", "#FFFFFF");
        });
    ...
    $scope.validerFormTiers = function () {
      if($scope.FormAddTiTiers.telWhatsApp == undefined || $scope.FormAddTiTiers.telWhatsApp == ""){
        $scope.FormAddTiTiers.telWhatsApp = ""
      }
      ...
      if (statutphoto.length != 0 && $scope.pretACharger1 == false) {
        ...
        if (
          ...
          $scope.FormAddTiTiers.sexe === "" ||
          $scope.FormAddTiTiers.sexe === undefined ||
          ...
          $scope.FormAddTiTiers.natureTiers === undefined ||
          $scope.FormAddTiTiers.tva === "" ||
          $scope.FormAddTiTiers.tva === undefined ||
          $scope.FormAddTiTiers.asdi === "" ||
          $scope.FormAddTiTiers.asdi === undefined ||
          $scope.FormAddTiTiers.plafondCredit === "" ||
          $scope.FormAddTiTiers.plafondCredit === undefined ||
          $scope.FormAddTiTiers.numCompte === "" ||
          $scope.FormAddTiTiers.numCompte === undefined ||
          $scope.FormAddTiTiers.pays === "" ||
          $scope.FormAddTiTiers.pays === undefined ||
          $scope.FormAddTiTiers.ville === "" ||
          $scope.FormAddTiTiers.ville === undefined ||
          ...
          $scope.FormAddTiTiers.localisation === undefined ||
          $scope.FormAddTiTiers.autorisationDescompte === "" ||
          $scope.FormAddTiTiers.autorisationDescompte === undefined
        ) {
          $scope.$emit("UNLOAD");
          $(document).ready(function () {
            if (
            ...
            if (
              ...
              $("#idNatTiers").css("background-color", "#FFE9E0");
            }
            if (
              $scope.FormAddTiTiers.tva === "" ||
              $scope.FormAddTiTiers.tva === undefined
            ...
            if (
              ...
              $("#idPlafondCred").css("background-color", "#FFE9E0");
            }
            if (
              $scope.FormAddTiTiers.numCompte === "" ||
              $scope.FormAddTiTiers.numCompte === undefined
            ...
            if (
              ...
              $("#idEscompte").css("background-color", "#FFE9E0");
            }
            if (
              $scope.FormAddTiTiers.telephone === "" ||
              $scope.FormAddTiTiers.telephone === undefined
          ...
          typeDate.test($scope.FormAddTiTiers.dateDeNaissance) == false
        ) {
          $scope.$emit("UNLOAD");
          $(document).ready(function () {
            $("#idDateNaissance").css("background-color", "#FFE9E0");
          ...
          typeMontant.test($scope.FormAddTiTiers.plafondCredit) == false
        ) {
          $scope.$emit("UNLOAD");
          $(document).ready(function () {
            $("#idPlafondCred").css("background-color", "#FFE9E0");
          ...
          typeNumerique.test($scope.FormAddTiTiers.numAgremant) == false
        ) {
          $scope.$emit("UNLOAD");
          $(document).ready(function () {
            $("#idAgrement").css("background-color", "#FFE9E0");
          });
          $scope.messageErreur = "Veuillez renseigner un n° agrement correct";
          $rootScope.MessageDerreurDesTypes($scope.messageErreur);
        } else if (
          ...
          $scope.FormAddTiTiers.fax !== "" &&
          typeNumeroTelephone.test($scope.FormAddTiTiers.fax) == false
        ) {
          $scope.$emit("UNLOAD");
          $(document).ready(function () {
            $("#idFax").css("background-color", "#FFE9E0");
          });
          $scope.messageErreur = "Veuillez renseigner un numéro fax correct";
          $rootScope.MessageDerreurDesTypes($scope.messageErreur);
          ...
          if ($scope.FormAddTiTiers.numclientaxa == undefined) {
            $scope.FormAddTiTiers.numclientaxa = "";
          }
          $scope.objet_envoie = [
            {
              AG_CODEAGENCE: $rootScope.CODE_AGENCE,
              ...
              NT_CODENATURETIERS: $scope.FormAddTiTiers.natureTiers,
              VL_CODEVILLE: $scope.FormAddTiTiers.ville,
              TI_SIEGE: "", //$scope.FormAddTiTiers.siege,
              SX_CODESEXE: $scope.FormAddTiTiers.sexe,
              FM_CODEFORMEJURIDIQUE: "",
              AC_CODEACTIVITE: $scope.FormAddTiTiers.secteurDactivite,
              TP_CODETYPETIERS: $scope.FormAddTiTiers.typeDuTiers,
              TC_CODECOMPTETYPETIERS: "", //$scope.FormAddTiTiers.typeCompteAdd,
              TI_DATENAISSANCE: $scope.FormAddTiTiers.dateDeNaissance,
              ...
              TI_ADRESSEGEOGRAPHIQUE: $scope.FormAddTiTiers.localisation,
              TI_TELEPHONE: $scope.FormAddTiTiers.telephone,
              TI_FAX: $scope.FormAddTiTiers.fax,
              TI_SITEWEB: $scope.FormAddTiTiers.siteWeb,
              TI_EMAIL: $scope.FormAddTiTiers.email,
              TI_GERANT: $scope.FormAddTiTiers.gerant,
              TI_STATUT: "N",
              TI_DATESAISIE: $rootScope.DATE_JOURNEE_DE_TRAVAIL,
              TI_ASDI: $scope.FormAddTiTiers.asdi,
              TI_TVA: $scope.FormAddTiTiers.tva,
              TI_STATUTDOUTEUX: "0",
              TI_PLAFONDCREDIT: $scope.FormAddTiTiers.plafondCredit,
              TI_NUMCPTECONTIBUABLE: "", //$scope.FormAddTiTiers.numCc,
              OP_CODEOPERATEUR: $scope.FormAddTiTiers.operateur,
              TI_DATEDEPART: "01-01-1900",
              TI_NUMEROAXA: $scope.FormAddTiTiers.numclientaxa,
              ...
              TI_NUMEROAGREMENT: $scope.FormAddTiTiers.numAgremant,
              TI_TAUXDECLARATION: "0",
              GP_CODEGROUPE: $scope.FormAddTiTiers.groupeDesTiers,
              TI_MANDATAIRE: "",
              TI_USAGER: "",
              IN_CODEINGREDIENT: "",
              TI_ESCOMPTE: $scope.FormAddTiTiers.autorisationDescompte,
              ZN_CODEZONE: "",
              TI_NUMWHATSAPP: $scope.FormAddTiTiers.telWhatsApp,
              RE_CODEREGIMEIMPOSITION: "", //$scope.FormAddTiTiers.regimeDimposition,
              SP_CODESPECIALITE: "", //$scope.FormAddTiTiers.specialite,
              QU_CODEQUARTIER: "",
              PF_CODEPROFESSION: $scope.FormAddTiTiers.profession,
              TI_LIEUNAISSANCE: "",
              ...
              if ($scope.tabEngTiers[0].clsObjetRetour.SL_RESULTAT === "TRUE") {
                ...
                if ($scope.etatForm == "2") {
                  $scope.RetourSurListe = function () {
                    window.location.href = "#/gestion/liste/tiers";
                  };
    ...
    $scope.retourModifDesTiers = function () {
      ...
      $scope.FormAddTiTiers.telWhatsApp = $scope.recupererInfo.TI_NUMWHATSAPP;
