MapharApp.controller("ProfilsController", [
  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
    ...
    $scope.retourModifProfils = function (info) {
      ...
      $scope.FormAddProfils.Code = $scope.recupererInfo.PO_CODEPROFIL;
    ...
    $scope.supprimeProfils = function () {
      ...
      $http
        .post("/Profils/SuppressionProfils/", $scope.objet_envoie, {
          //headers: $scope.headers
        })
        .then(function (reponse) {
    ...
    $scope.ajoutProfils = function () {
      ...
      if (
        ...
        if ($scope.etatForm != "2") {
          $http
            .post("/Profils/AjoutProfils/", $scope.objet_envoie, {
              //headers: $scope.headers
            })
            .then(function (reponse) {
          ...
          $http
            .post("/Profils/ModificationProfils/", $scope.objet_envoie, {
              //headers: $scope.headers
            })
            .then(function (reponse) {
              ...
              if (
                ...
                $scope.RetourSurListe = function () {
                  window.location.href = "#/OutilsetSecurite/liste/profils";
                };
