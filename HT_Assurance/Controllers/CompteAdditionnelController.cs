...
{
    public class CompteAdditionnelController : Controller
    {
        public JsonResult ListeCompteAdditionnel(List<HT_Stock.BOJ.clsPhapartypetierscompterattacheadditionnel > ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPhapartypetierscompterattacheadditionnels = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebCompteAdditionel.URL_SELECT_COMPTE_ADDITIONNEL, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsPhapartypetierscompterattacheadditionnel .clsObjetRetour = clsObjetRetour;
                clsPhapartypetierscompterattacheadditionnels.Add(clsPhapartypetierscompterattacheadditionnel );  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error CompteAdditionnelController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsPhapartypetierscompterattacheadditionnel .clsObjetRetour = clsObjetRetour;
                clsPhapartypetierscompterattacheadditionnels.Add(clsPhapartypetierscompterattacheadditionnel ); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error CompteAdditionnelController :" + ex.Message);
            }
