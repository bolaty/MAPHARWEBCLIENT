...
namespace HT_Assurance.Controllers
{
    ...
    public class EditionTresorerieController : Controller
    {
        ...
        public JsonResult ListeZoneEditionCombo(List<HT_Stock.BOJ.clsEdition> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsEditions = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_SELECT_COMBOZONEEDITION, Tokken).ToList();
        ...
        public JsonResult ListeSuccursales(List<HT_Stock.BOJ.clsEdition> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditions = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_SELECT_COMBOSUCCURSALES, Tokken).ToList();
                    if ((clsEditions == null) || (clsEditions.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        public JsonResult ListeExercice(List<HT_Stock.BOJ.clsEdition> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditions = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_SELECT_COMBOEXERCICE, Tokken).ToList();
                    if ((clsEditions == null) || (clsEditions.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        public JsonResult ListePeriodicite(List<HT_Stock.BOJ.clsEdition> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                {
                    //debut traitement des criteres de recherche non obligatoire
                    if (string.IsNullOrEmpty(ObjetEnvoie[Idx].PE_CODEPERIODICITE))
                        ObjetEnvoie[Idx].PE_CODEPERIODICITE = "";
                }
                Assurance.Outils.clsDeclaration.TestConnexionServeur = Core.clsAppelServiceWeb.IsNetworkConnected(); //Vérification de la connexion avec la partie serveur
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditions = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_SELECT_PERIODICITE, Tokken).ToList();
                    if ((clsEditions == null) || (clsEditions.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        public JsonResult ListePeriode(List<HT_Stock.BOJ.clsEdition> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditions = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_SELECT_PERIODE, Tokken).ToList();
                    if ((clsEditions == null) || (clsEditions.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        /*public JsonResult ListeTypeTiers(List<HT_Stock.BOJ.clsPhapartypetiers> ObjetEnvoie)
         {
             ...
             try
             {
                 ...
                 {
                     //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                     clsPhapartypetierss = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_SELECT_COMBOEXERCICE, Tokken).ToList();
        ...
        public JsonResult Inserteditiontresorerie(List<HT_Stock.BOJ.clsEditionEtatParametre> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditionEtatParametres = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_INSERT_URL_EDITION_TRESORERIE, Tokken).ToList();
        ...
        public JsonResult Inserteditiontresorerie1(List<HT_Stock.BOJ.clsEditionEtatCaisse> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditionEtatCaisses = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_INSERT_EDITION_TRESORERIE_1, Tokken).ToList();
                    ...
                    Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_TRESORERIE_1 = new List<clsEditionEtatCaisse>();
                    Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_TRESORERIE_1 = clsEditionEtatCaisses;
                    Assurance.Outils.clsDeclaration.vappNomFormule = new string[] { "Entete1", "Entete2", "Entete3", "Entete4", "LibelleEtat", "Date1", "Date2" };
                    Assurance.Outils.clsDeclaration.vappValeurFormule = new string[] { Assurance.Outils.clsDeclaration.ENTETE1_VALEUR, Assurance.Outils.clsDeclaration.ENTETE2_VALEUR, Assurance.Outils.clsDeclaration.ENTETE3_VALEUR, Assurance.Outils.clsDeclaration.ENTETE4_VALEUR, ObjetEnvoie[0].SL_VALEURRETOURS, ObjetEnvoie[0].DATEDEBUT, ObjetEnvoie[0].DATEFIN };
        ...
        public JsonResult Inserteditiontresorerie2(List<HT_Stock.BOJ.clsEditionEtatStock> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsEditionEtatStocks = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebEditionTresorerie.URL_INSERT_EDITION_TRESORERIE_2, Tokken).ToList();
                    ...
                    Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_TRESORERIE_2 = new List<clsEditionEtatStock>();
                    Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_TRESORERIE_2 = clsEditionEtatStocks;
                    Assurance.Outils.clsDeclaration.vappNomFormule = new string[] { "Entete1", "Entete2", "Entete3", "Entete4", "LibelleEtat", "Date1", "Date2" };
                    Assurance.Outils.clsDeclaration.vappValeurFormule = new string[] { Assurance.Outils.clsDeclaration.ENTETE1_VALEUR, Assurance.Outils.clsDeclaration.ENTETE2_VALEUR, Assurance.Outils.clsDeclaration.ENTETE3_VALEUR, Assurance.Outils.clsDeclaration.ENTETE4_VALEUR, ObjetEnvoie[0].SL_VALEURRETOURS, ObjetEnvoie[0].DATEDEBUT, ObjetEnvoie[0].DATEFIN };
                }
                else
        ...
        public JsonResult pvgAfficherEtat1()
        {
            ...
            try
            {
                ...
                rd.FileName = Assurance.Outils.clsDeclaration.CHEMIN_REPORTS + "TRESORERIE\\" + Assurance.Outils.clsDeclaration.NOM_ETAT_EN_COURS; // Recuperation du fier .rpt Assurance.Outils.clsDeclaration.NOM_ETAT_EN_COURS
                DateTime date = DateTime.Today; // Recuperation de la date du jour

                rd.SetDataSource(Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_TRESORERIE_1);  // liaison entre le fichier rpt et les données qu'il doit contenir
            ...
            Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEEASSURANCE = new List<Core.clsEditionEtatAssurance>();
        ...
        public JsonResult pvgAfficherEtat2()
        {
            ...
            try
            {
                // declaration du fichier généré
                ReportDocument rd = new ReportDocument(); // Création d'une instance document
                rd.FileName = Assurance.Outils.clsDeclaration.CHEMIN_REPORTS + "TRESORERIE\\" + Assurance.Outils.clsDeclaration.NOM_ETAT_EN_COURS; // Recuperation du fichier .rpt Assurance.Outils.clsDeclaration.NOM_ETAT_EN_COURS
                DateTime date = DateTime.Today; // Recuperation de la date du jour

                rd.SetDataSource(Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_TRESORERIE_2);  // liaison entre le fichier rpt et les données qu'il doit contenir
