...
{
    public class TypeBudgetParamIIController : Controller
    {
        

        //BLOC LISTE
        public JsonResult ListeTypeBudgetParamII(List<HT_Stock.BOJ.clsMicbudgetparamtype> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsMicbudgetparamtypes = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceTypeBudget.URL_SELECT_TYPE_BUDGET, Tokken).ToList();
        ...
        public JsonResult INSERTParamII(List<HT_Stock.BOJ.clsMicbudgetparamtype> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            HT_Stock.BOJ.clsMicbudgetparamtype clsMicbudgetparamtype = new HT_Stock.BOJ.clsMicbudgetparamtype();  //Déclaration d'une instance de l'objet equipe_operateurs
            HT_Stock.BOJ.clsMicbudgetparamtype ObjetRetour = new HT_Stock.BOJ.clsMicbudgetparamtype(); //Conteneur de la réponse de l'appel du service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsMicbudgetparamtypes = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceTypeBudget.URL_INSERT_TYPE_BUDGET, Tokken).ToList();
                    if ((clsMicbudgetparamtypes == null) || (clsMicbudgetparamtypes.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        public JsonResult UPDATEParamII(List<HT_Stock.BOJ.clsMicbudgetparamtype> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            HT_Stock.BOJ.clsMicbudgetparamtype clsMicbudgetparamtype = new HT_Stock.BOJ.clsMicbudgetparamtype();  //Déclaration d'une instance de l'objet equipe_operateurs
            HT_Stock.BOJ.clsMicbudgetparamtype ObjetRetour = new HT_Stock.BOJ.clsMicbudgetparamtype(); //Conteneur de la réponse de l'appel du service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsMicbudgetparamtypes = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceTypeBudget.URL_UPDATE_TYPE_BUDGET, Tokken).ToList();
                    if ((clsMicbudgetparamtypes == null) || (clsMicbudgetparamtypes.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        public JsonResult DELETEParamII(List<HT_Stock.BOJ.clsMicbudgetparamtype> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            HT_Stock.BOJ.clsMicbudgetparamtype clsMicbudgetparamtype = new HT_Stock.BOJ.clsMicbudgetparamtype();  //Déclaration d'une instance de l'objet equipe_operateurs
            HT_Stock.BOJ.clsMicbudgetparamtype ObjetRetour = new HT_Stock.BOJ.clsMicbudgetparamtype(); //Conteneur de la réponse de l'appel du service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsMicbudgetparamtypes = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceTypeBudget.URL_DELETE_TYPE_BUDGET, Tokken).ToList();
                    if ((clsMicbudgetparamtypes == null) || (clsMicbudgetparamtypes.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
        ...
        public JsonResult COMBOParamII(List<HT_Stock.BOJ.clsMicbudgetparamtype> ObjetEnvoie)
        {
            string Tokken = "";//Request.Headers.Authorization.ToString();  //Tokken du client qui demande le service web
            HT_Stock.BOJ.clsMicbudgetparamtype clsMicbudgetparamtype = new HT_Stock.BOJ.clsMicbudgetparamtype();  //Déclaration d'une instance de l'objet equipe_operateurs
            HT_Stock.BOJ.clsMicbudgetparamtype ObjetRetour = new HT_Stock.BOJ.clsMicbudgetparamtype(); //Conteneur de la réponse de l'appel du service web
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsMicbudgetparamtypes = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceTypeBudget.URL_COMBO_TYPE_BUDGET, Tokken).ToList();
                    if ((clsMicbudgetparamtypes == null) || (clsMicbudgetparamtypes.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
