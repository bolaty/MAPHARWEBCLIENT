...
{
    public class NumCompteGeneralController : Controller
    {
        public JsonResult ListeNumCompteGeneral(List<HT_Stock.BOJ.clsPlancomptable> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPlancomptables = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceNumCompteGeneral.URL_SELECT_NUMERO_COMPTE_GENERAL, Tokken).ToList();
