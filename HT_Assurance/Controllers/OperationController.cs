...
namespace HT_Assurance.Controllers
{
    ...
    {
        public JsonResult ListeOperation(List<HT_Stock.BOJ.clsPlancomptable> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPlancomptables = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebOperation.URL_SELECT_OPERATION, Tokken).ToList();
