...
{
    public class RecuImpressionController : Controller
    {
        

        //BLOC LISTE
        public JsonResult ListeRecuImpression(List<HT_Stock.BOJ.clsPhamouvementstockreglement> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPhamouvementstockreglements = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceRecuImpression.URL_SELECT_RECU, Tokken).ToList();
                    ...
                    {
                        Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_RECUREGLEMENT = new List<HT_Stock.BOJ.clsPhamouvementstockreglement>();
                        Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEE_EDITION_RECUREGLEMENT = clsPhamouvementstockreglements;
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsPhamouvementstockreglement.clsObjetRetour = clsObjetRetour;
                clsPhamouvementstockreglements.Add(clsPhamouvementstockreglement);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error ListeRecuImpression :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsPhamouvementstockreglement.clsObjetRetour = clsObjetRetour;
                clsPhamouvementstockreglements.Add(clsPhamouvementstockreglement); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error ListeRecuImpression :" + ex.Message);
            }
            Assurance.Outils.clsDeclaration.SOURCE_DE_DONNEERECU = clsPhamouvementstockreglements;
