...
{
    public class MontantfactureController : Controller
    {
        public JsonResult ListeMontanfacture(List<HT_Stock.BOJ.clsCtcontrat> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsCtcontrats = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebMontantfacture.URL_SELECT_MONTANTFACTURE, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsCtcontrat.clsObjetRetour = clsObjetRetour;
                clsCtcontrats.Add(clsCtcontrat);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error MontantfactureController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsCtcontrat.clsObjetRetour = clsObjetRetour;
                clsCtcontrats.Add(clsCtcontrat); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error MontantfactureController :" + ex.Message);
            }
