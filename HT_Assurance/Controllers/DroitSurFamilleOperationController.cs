...
{
    public class DroitSurFamilleOperationController : Controller
    {
       //BLOC LISTE
        public JsonResult ListeDroitSurFamilleOperation(List<HT_Stock.BOJ.clsLogicielobjettypeoperationoperateur> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsLogicielobjettypeoperationoperateurs = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebDroitSurFamilleOperation.URL_LISTE_DROIT_SUR_FAMILLE_OPERATION, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsLogicielobjettypeoperationoperateur.clsObjetRetour = clsObjetRetour;
                clsLogicielobjettypeoperationoperateurs.Add(clsLogicielobjettypeoperationoperateur);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error DroitSurFamilleOperationController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsLogicielobjettypeoperationoperateur.clsObjetRetour = clsObjetRetour;
                clsLogicielobjettypeoperationoperateurs.Add(clsLogicielobjettypeoperationoperateur); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error DroitSurFamilleOperationController :" + ex.Message);
            }
            return Json(clsLogicielobjettypeoperationoperateurs, JsonRequestBehavior.AllowGet);
        }
         //BLOC MISE A JOUR
        public JsonResult AjoutDroitSurFamilleOperation(List<HT_Stock.BOJ.clsLogicielobjettypeoperationoperateur> ObjetEnvoie)

        {
            ...
            try
            {
                ...
                {
                    //appelle du service web de generation de la liste des equipe_operateurs personnels et affectation a la variable retour
                    clsLogicielobjettypeoperationoperateurs = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebDroitSurFamilleOperation.URL_AJOUT_DROIT_SUR_FAMILLE_OPERATION, Tokken).ToList();
                    if ((clsLogicielobjettypeoperationoperateurs == null) || (clsLogicielobjettypeoperationoperateurs.Count == 0))
                    {
                        clsObjetRetour.SL_RESULTAT = Core.clsDeclaration.SL_RESULTAT_ERROR;  //RESULTAT = FALSE
                        clsObjetRetour.SL_MESSAGE = Core.clsDeclaration.ERR_MSG_CONN;  //MSG = ERREUR DE CONNEXION
