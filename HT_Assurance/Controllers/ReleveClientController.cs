...
{
    public class ReleveClientController : Controller
    {
        public JsonResult ListeReleveClient(List<HT_Stock.BOJ.clsCtsinistre> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsCtsinistres = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebReleveClient.URL_SELECT_RELEVE_CLIENT, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsCtsinistre.clsObjetRetour = clsObjetRetour;
                clsCtsinistres.Add(clsCtsinistre);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error ReleveClientController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsCtsinistre.clsObjetRetour = clsObjetRetour;
                clsCtsinistres.Add(clsCtsinistre); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error ReleveClientController :" + ex.Message);
            }
