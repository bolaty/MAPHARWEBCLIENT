...
namespace HT_Assurance.Controllers
{
    ...
    {
        public JsonResult ListeTypeDuClient(List<HT_Stock.BOJ.clsPhaparnaturetiers> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPhaparnaturetierss = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebTypeClient.URL_SELECT_TYPE_CLIENT, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsPhaparnaturetiers.clsObjetRetour = clsObjetRetour;
                clsPhaparnaturetierss.Add(clsPhaparnaturetiers);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error TypeClientController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsPhaparnaturetiers.clsObjetRetour = clsObjetRetour;
                clsPhaparnaturetierss.Add(clsPhaparnaturetiers); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error TypeClientController :" + ex.Message);
            }
