...
{
    public class NatureSinistreController : Controller
    {
        public JsonResult ListeNatureSinistre(List<HT_Stock.BOJ.clsCtparnaturesinistre> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsCtparnaturesinistres = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebNatureSinistre.URL_SELECT_NATURE_SINISTRE, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsCtparnaturesinistre.clsObjetRetour = clsObjetRetour;
                clsCtparnaturesinistres.Add(clsCtparnaturesinistre);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error NatureSinistreController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsCtparnaturesinistre.clsObjetRetour = clsObjetRetour;
                clsCtparnaturesinistres.Add(clsCtparnaturesinistre); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error NatureSinistreController :" + ex.Message);
            }
