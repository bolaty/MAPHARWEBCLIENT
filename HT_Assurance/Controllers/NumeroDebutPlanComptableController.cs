...
{
    public class NumeroDebutPlanComptableController : Controller
    {
        public JsonResult ListeNumeroDebutPlanComptable(List<HT_Stock.BOJ.clsPlancomptable> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPlancomptables = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceWebNumeroDebutPlanComptable.URL_SELECT_NUMERO_DEBUTPLAN_COMPTABLE, Tokken).ToList();
