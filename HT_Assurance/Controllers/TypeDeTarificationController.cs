...
{
    public class TypeDeTarificationController : Controller
    {
        public JsonResult ListeTypeDeTarification(List<HT_Stock.BOJ.clsCtpartarif> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsCtpartarifs = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebTypeDeTarification.URL_SELECT_TYPE_DE_TARIFICATION, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsCtpartarif.clsObjetRetour = clsObjetRetour;
                clsCtpartarifs.Add(clsCtpartarif);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error TypeDeTarificationController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsCtpartarif.clsObjetRetour = clsObjetRetour;
                clsCtpartarifs.Add(clsCtpartarif); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error TypeDeTarificationController :" + ex.Message);
            }
