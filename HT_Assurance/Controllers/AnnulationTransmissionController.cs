...
{
    public class AnnulationTransmissionController : Controller
    {
        public JsonResult ListeAnnulationTransmission(List<HT_Stock.BOJ.clsCtcontrat> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsCtcontrats = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebAnnulationTransmission.URL_SELECT_ANNULATION_TRANSMISSION, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsCtcontrat.clsObjetRetour = clsObjetRetour;
                clsCtcontrats.Add(clsCtcontrat);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error AnnulationTransmissionController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsCtcontrat.clsObjetRetour = clsObjetRetour;
                clsCtcontrats.Add(clsCtcontrat); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error AnnulationTransmissionController :" + ex.Message);
            }
