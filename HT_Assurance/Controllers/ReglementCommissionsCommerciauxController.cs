...
{
    public class ReglementCommissionsCommerciauxController : Controller
    {
        

        //BLOC LISTE
        public JsonResult EnregReglementCommissionsCommerciaux(List<HT_Stock.BOJ.clsPhamouvementstockreglement> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsPhamouvementstockreglements = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferenceReglementCommissionsCommerciaux.URL_SELECT_REGLEMENT_COMMISSIONS_COMMERCIAUX, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsPhamouvementstockreglement.clsObjetRetour = clsObjetRetour;
                clsPhamouvementstockreglements.Add(clsPhamouvementstockreglement);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error ReglementCommissionsCommerciauxController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsPhamouvementstockreglement.clsObjetRetour = clsObjetRetour;
                clsPhamouvementstockreglements.Add(clsPhamouvementstockreglement); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error ReglementCommissionsCommerciauxController :" + ex.Message);
            }
