...
{
    public class SensController : Controller
    {
        public JsonResult ListeSens(List<HT_Stock.BOJ.clsSENS> ObjetEnvoie)
        {
            ...
            try
            {
                ...
                if (Assurance.Outils.clsDeclaration.TestConnexionServeur == true) //Opération a realiser si la connnexion est établie
                {
                    ...
                    clsSENSs = Core.clsAppelServiceWeb.ExecuteServiceWeb(ObjetRetour, ObjetEnvoie, Core.clsDeclaration.METHOD, 0, Assurance.Outils.ReferencesWebSens.URL_SELECT_SENS, Tokken).ToList();
            ...
            catch (System.Net.WebException e)  //Exeptions liées au serveur
            {
                ...
                clsSENS.clsObjetRetour = clsObjetRetour;
                clsSENSs.Add(clsSENS);  //Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error SensController :" + e.Message);
            ...
            catch (Exception ex)  //Exeptions liées au code
            {
                ...
                clsSENS.clsObjetRetour = clsObjetRetour;
                clsSENSs.Add(clsSENS); // Ajout d'une nouvelle instance de la classe a la liste
                Core.clsLog.EcrireDansFichierLog("Error SensController :" + ex.Message);
            }
