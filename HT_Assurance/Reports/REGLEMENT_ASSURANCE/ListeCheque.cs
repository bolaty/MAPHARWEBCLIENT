...
namespace HT_Assurance.Reports.REGLEMENT_ASSURANCE {
    using System;
    ...
    public class ListeCheque : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HT_Assurance.Reports.REGLEMENT_ASSURANCE.ListeCheque.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedListeCheque : Component, ICachedReport {
        
        public CachedListeCheque() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ListeCheque rpt = new ListeCheque();
            rpt.Site = this.Site;
            return rpt;
        }
