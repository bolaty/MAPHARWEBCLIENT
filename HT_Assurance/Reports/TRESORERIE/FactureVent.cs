...
namespace HT_Assurance.Reports.TRESORERIE {
    ...
    public class FactureVent : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HT_Assurance.Reports.TRESORERIE.FactureVent.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedFactureVent : Component, ICachedReport {
        
        public CachedFactureVent() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FactureVent rpt = new FactureVent();
            rpt.Site = this.Site;
            return rpt;
        }
