...
namespace HT_Assurance.Reports.TRESORERIE {
    ...
    public class FactureCmd1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HT_Assurance.Reports.TRESORERIE.FactureCmd1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedFactureCmd1 : Component, ICachedReport {
        
        public CachedFactureCmd1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FactureCmd1 rpt = new FactureCmd1();
            rpt.Site = this.Site;
            return rpt;
        }
