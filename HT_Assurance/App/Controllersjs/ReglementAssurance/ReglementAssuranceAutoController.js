MapharApp.controller("ReglementAssuranceAutoController", [
  "$scope",
  "$http",
  "$q",
  "$location",
  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
    ...
    $scope.SL_LIBELLEECRAN = "REGLEMENT CONTRAT AUTO";
    ...
    $scope.autreOption = function (collContrat, infoContrat) {
      ...
      localStorage.setItem(
        "vpreglAssurMultirisqueProinfocontrat",
