...
namespace Assurance.Outils
{
    public class clsDeclaration
    {
        ...
        public static List<Core.clsEditionEtatAssurance> SOURCE_DE_DONNEEASSURANCE = new List<Core.clsEditionEtatAssurance>();
        public static List<Core.clsEditionEtatAssurance> SOURCE_DE_DONNEEASSURANCE2 = new List<Core.clsEditionEtatAssurance>();
        ...
        public static List<HT_Stock.BOJ.clsCtcontratchequephoto> SOURCE_DE_DONNEEREMISEDECHECQUE = new List<HT_Stock.BOJ.clsCtcontratchequephoto>();
